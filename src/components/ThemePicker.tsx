...
export function ThemePicker({ onThemeChange }: { readonly onThemeChange: (theme: Theme) => void }) {
  ...
  return (
    <div className="flex gap-2 items-center py-2">
      ...
      <select
        className="rounded px-2 py-1 border border-gray-300 bg-gray-100 text-gray-900 text-xs"
        value={selected}
